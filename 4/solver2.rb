...
def search_top_m arr, x, y
  ...
  return true if tl == "M" && tr == "M" && bl == "S" && br == "S"
end
...
def search_bot_m arr, x, y
  ...
  bl = get_index arr, x-1, y+1
  br = get_index arr, x+1, y+1
  return true if tl == "S" && tr == "S" && bl == "M" && br == "M"
end
...
def search_right_m arr, x, y
  ...
  bl = get_index arr, x-1, y+1
  br = get_index arr, x+1, y+1
  return true if tl == "S" && tr == "M" && bl == "S" && br == "M"
end
...
def search_left_m arr, x, y
  ...
  bl = get_index arr, x-1, y+1
  br = get_index arr, x+1, y+1
  return true if tl == "M" && tr == "S" && bl == "M" && br == "S"
end
